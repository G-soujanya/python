class Customer:
    def ___init__(self,customer_id,customer_name,address):
...
class Freight:
    ...
    def forward_cargo(self):
        if(self.__from_customer.validate_customer_id() and self.recipient_customer.validate_customer_id() and self.validate_distance() and self.validate_distance()):
            Freight.counter+=2
