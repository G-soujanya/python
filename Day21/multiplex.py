class Multiplex:
    ...
    def  generate_seat_number(self,movie_index,number_of_tickets):
        list_of_generated_seat_numbers=[]
        for i in range(number_of_tickets):
            seat_number="M"+Multiplex.__list_movie_name[movie_index][-1]+"-"+str(i+1)
            list_of_generated_seat_numbers.append(seat_number)
        Multiplex.__list_total_tickets[movie_index]-=number_of_tickets
        Multiplex.__list_last_seat_number[movie_index]=seat_number
        return list_of_generated_seat_numbers
booking1=Multiplex()
